...
public abstract class Borderable extends Intersectable
{
    ...
    protected boolean intersectBorder(Ray ray)
    {
        ...
        double originX = origin.getD1();
        double originY = origin.getD2();
        double originZ = origin.getD3();
        Vector dir = ray.getVector();
        double dirX = dir.getD1();
        double dirY = dir.getD2();
        double dirZ = dir.getD3();
    ...
    public abstract   List<GeoPoint> findGeoIntersectionsParticular(Ray ray);
