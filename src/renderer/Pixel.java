 ...
 * thread.
 *• פעולות סטטיות לאתחול המודול ולמעקב התקדמות יצירת התמונה כאחוז מהפיקסלים שכבר נצבעו
 * • יצירת אובייקט עבור כל תהליכון שמאפשר לתהליכון לבחור את הפיקסל הבא לאיבוד, תוך שמירת בקרה על הקטעים
 * הקריטי ים בעזרת mutex -ים למניעת שיבושים בין התהליכונים בבחירת הפיקסלים.
 * @author Dan
 *
 */
class Pixel {
    ...
    public static long printInterval = 100l;
