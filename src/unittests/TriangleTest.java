...
class TriangleTests {
    ...
    public void testfindIntersections()
    {
        try
        {
            ...
            Ray ray = new Ray(new Point(6.94, -2.39, 0), new Vector(new Double3(-2.68, 5.72, 0)));
            ...
            ray = new Ray(new Point(-0.93, 6.2, 0), new Vector(new Double3(2.54, 2.23, 0)));
            assertNull( triangle.findIntersections(ray),"the intersection point is out of the triangle - need 0 intersections");

            // TC03: The ray cuts the plane within the boundaries of the triangle
            ray = new Ray(new Point(-2.09, 2.69, 2.3), new Vector(new Double3(4.09, -0.69, -2.3)));
            ...
            ray = new Ray(new Point(4.26, -1.28, 2.14), new Vector(new Double3(-0.15, 3.07, -2.14)));
            ...
            ray = new Ray(new Point(3.7, -0.71, 1.44), new Vector(new Double3(1.3, 0.71, -1.44)));
            ...
            ray = new Ray(new Point(3.86, -4.95, 0), new Vector(new Double3(2.97, 1.28, 0)));
            assertNull( triangle.findIntersections(ray),"the intersection point is out of the triangle - need 0 intersections");
